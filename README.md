...
Athena Parent 是 Athena 微服务生态系统的核心基础平台，基于 Spring Boot 3.5.4 和 Spring Cloud 2025.0.0
构建。项目采用现代化的架构设计，集成了云原生、AI、消息队列、第三方服务等企业级功能模块，为微服务应用开发提供统一的依赖管理、通用工具类和自动配置启动器。
