...
Athena Parent 是 Athena 微服务平台的基础工具包，基于 Spring Boot 3.5.0 构建，提供统一的依赖管理、通用工具类、第三方SDK集成和自动配置启动器。本模块采用模块化设计，为整个
Athena 生态系统提供坚实的基础支撑。
...
sendMessage(chatId, "Hello, Feishu!");
```
