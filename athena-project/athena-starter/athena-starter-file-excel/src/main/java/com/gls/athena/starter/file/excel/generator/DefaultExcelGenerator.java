...
import com.gls.athena.starter.file.excel.annotation.ExcelSheet;
import com.gls.athena.starter.file.excel.config.ExcelProperties;
import com.gls.athena.starter.file.excel.customizer.WriteSheetCustomizer;
import com.gls.athena.starter.file.excel.customizer.WriteTableCustomizer;
import com.gls.athena.starter.file.excel.customizer.WriteWorkbookCustomizer;
import com.gls.athena.starter.file.excel.support.ExcelDataUtil;
...
public class DefaultExcelGenerator implements ExcelGenerator {
    ...
    public boolean supports(ExcelResponse excelResponse) {
        return StrUtil.isBlank(excelResponse.template())
