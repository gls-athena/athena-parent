...
public class DelegateOAuth2UserService implements OAuth2UserService<OAuth2UserRequest, OAuth2User> {
    ...
    public OAuth2User loadUser(OAuth2UserRequest userRequest) throws OAuth2AuthenticationException {
        ...
        OAuth2User oauth2User = adapterManager.getAdapter(userRequest.getClientRegistration())
        ...
        SocialUser socialUser = Optional.ofNullable(socialUserService.loadSocialUser(registrationId, oauth2User.getName()))
                .orElseGet(() -> getSocialUser(oauth2User, registrationId));
     ...
     */
    private SocialUser getSocialUser(OAuth2User oauth2User, String registrationId) {
        // 如果社交用户不存在，则创建新的社交用户
